...
use Marek\Toggable\API\Http\Request\Workspace\WorkspaceTags;

class WorkspaceTagsTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var WorkspaceTags
     */
    ...
    {
        $this->request = new WorkspaceTags(
            array(
                'workspaceId' => 123,
            )
        );
    ...
    {
        $this->assertEquals('workspaces/123/tags', $this->request->getUri());
    }
